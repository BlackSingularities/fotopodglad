...
- **Ustawienia** — dostępne przy starcie i w dowolnym momencie skrótem `Ctrl+P`. Pozwalają m.in. włączyć/wyłączyć automatyczny hotspot, ustawić wielkość QR i czas ręcznego podglądu od 3 do 900 sekund. Po zapisaniu aplikacja uruchamia się ponownie.
