...
public static class LocalizationService
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        // Nagłówki zakładek okna ustawień.
        ["Ekrany"] = "Displays", ["Folder i galeria"] = "Folder and gallery", ["Podgląd"] = "Preview",
        ["Udostępnianie"] = "Sharing", ["Wygląd"] = "Appearance",
        ["Siatka zdjęć"] = "Photo grid", ["Widoczne zdjęcia"] = "Visible photos",
        ["Wybór zdjęcia"] = "Photo selection", ["Narzędzia fotografa"] = "Photographer tools",
        ["Co pobiera gość"] = "What guests download", ["Rozmiar (dłuższy bok)"] = "Size (longer side)",
        ["Format pliku"] = "File format", ["Jakość JPEG"] = "JPEG quality",
        ["Zdjęcie widoczne w podglądzie ma w siatce ramkę w kolorze akcentu."] = "The photo shown in the preview is framed in the accent color in the grid.",
        ["Strzałki w obu oknach przechodzą po zdjęciach widocznych w siatce, więc filtr obowiązuje także dla klawiatury."] = "The arrow keys in both windows move through the photos visible in the grid, so the filter applies to the keyboard as well.",
        ["Zmiana rozmiaru wymaga ponownego zakodowania pliku, dlatego format jest wtedy ustawiony na JPEG. Pliki PNG pozostają PNG."] = "Resizing requires re-encoding the file, so the format is set to JPEG in that case. PNG files stay PNG.",
        ["Zdjęcia źródłowe nigdy nie są modyfikowane — przekodowana kopia powstaje wyłącznie w pamięci na czas pobierania."] = "Source photos are never modified — the re-encoded copy exists only in memory for the duration of the download.",
        ["Domyślnie gość dostaje oryginalny plik bez rekompresji. W zakładce Udostępnianie można wybrać mniejszy dłuższy bok i jakość JPEG — wtedy telefon pobiera lżejszą kopię, a pliki RAW, TIFF i HEIC zamieniają się w JPEG, który otworzy każde urządzenie. Pliki PNG pozostają PNG."] = "By default a guest receives the original file without recompression. The Sharing tab lets you pick a smaller longer side and a JPEG quality — the phone then downloads a lighter copy, and RAW, TIFF and HEIC files become JPEG files that open on any device. PNG files stay PNG.",
        ["Limit równoległych pobrań chroni komputer i sieć przed przeciążeniem. Po pięciu minutach bez pobierania hasło sesji jest zmieniane, a kody QR aktualizują się automatycznie."] = "A concurrent-download limit protects the computer and the network from overload. After five minutes without a download the session password is rotated and the QR codes update automatically.",
        ["Dostępność podglądu konkretnego pliku RAW lub HEIC zależy od jego wariantu oraz kodeków dostępnych w systemie."] = "Preview availability for a particular RAW or HEIC file depends on its variant and on the codecs available in the system.",
        ...
        ["Folder zdjęć"] = "Photo folder", ["Wybierz…"] = "Browse…",
        ...
        ["Nie sprawdzano w tej sesji."] = "Not checked in this session.",
