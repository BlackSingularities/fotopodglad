...
public static class LocalizationService
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Pokazuje wybrane albo najnowsze zdjęcie w dużym formacie. Może wyświetlać EXIF, histogram oraz ostrzeżenia o przepaleniach i niedoświetleniach."] = "Shows the selected or latest photo at a large size. It can display EXIF data, a histogram and clipped highlight or shadow warnings.",
